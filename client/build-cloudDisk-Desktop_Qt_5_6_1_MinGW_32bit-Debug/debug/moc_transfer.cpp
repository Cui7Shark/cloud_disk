...
QT_MOC_LITERAL(1, 9, 16), // "currentTabSignal"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Transfer\0currentTabSignal\0"
};
...
void Transfer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->currentTabSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Transfer::currentTabSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Transfer::currentTabSignal(QString _t1)
{
